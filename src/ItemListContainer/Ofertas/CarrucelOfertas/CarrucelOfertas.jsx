...
const CarrucelOfertas = ({imagenes}) => {
    ...
    function calcularPorcentaje(price, offer){
        let descuento = price - offer;
        return( descuento / price) *100;
    }
        ...
        <div className="carrusel-container">
            <div className="carrusel-wrapper">
                {[0, 1, 2, 3].map((offset) => {
                    ...
                    const precioProd = imagenes[imageIndex].offer
                    const precioDividio = CalcularPrecio(precioProd)
                    
                    const porcentaje= parseInt(calcularPorcentaje(imagenes[imageIndex].price, imagenes[imageIndex].offer))
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="carrusel-caption">
                                ...
                                <section className='alingRowP'>
                                    <p className='text-decoration-line-through'>${imagenes[imageIndex].price}</p> <p className='fw-bold px-2'> ${imagenes[imageIndex].offer}</p>
                                </section>
...
export default CarrucelOfertas